...
const babelLoaderConfiguration = {
  ...
  include: [
    ...
    path.resolve(appDirectory, 'node_modules/react-native-amap3d'),
    // path.resolve(appDirectory, 'node_modules/jpush-react-native'),
    path.resolve(
      appDirectory,
      'node_modules/@react-native-community/viewpager',
    ),
